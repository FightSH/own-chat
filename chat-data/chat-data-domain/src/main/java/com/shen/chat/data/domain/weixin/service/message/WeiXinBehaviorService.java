package com.shen.chat.data.domain.weixin.service.message;

import com.google.common.cache.Cache;
import com.shen.chat.data.domain.weixin.model.entity.MessageTextEntity;
import com.shen.chat.data.domain.weixin.model.entity.UserBehaviorMessageEntity;
import com.shen.chat.data.domain.weixin.model.valobj.MsgTypeVO;
import com.shen.chat.data.domain.weixin.service.IWeiXinBehaviorService;
import com.shen.chat.data.types.exception.ChatException;
import com.shen.chat.data.types.sdk.wechat.XmlUtil;
...
public class WeiXinBehaviorService implements IWeiXinBehaviorService {
    ...
    public String acceptUserBehavior(UserBehaviorMessageEntity userBehaviorMessageEntity) {
        ...
        throw new ChatException(userBehaviorMessageEntity.getMsgType() + " 未被处理的行为类型 Err！");
    }
}
